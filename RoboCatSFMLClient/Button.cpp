...
//#include "../RoboCatSFMLClient/TextureManager.hpp"
//#include "../RoboCatSFMLClient/FontManager.hpp"
...
namespace GUI
{
		...
		//, m_sounds(*context.sounds)
	{
		...
		//mSpriteComponent->SetTexture(TextureManager::sInstance->GetTexture("buttons"));
		//m_sprite.SetTexture(TextureManager::sInstance->GetTexture("buttons"));
	}
